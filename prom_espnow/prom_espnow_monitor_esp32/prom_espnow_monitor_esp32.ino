...
/*
const uint8_t TARGET_MACS[][6] = {
    { 0xF6, 0x04, 0x9F, 0x6D, 0xF5, 0xE6 },	// Google Pixel 9 Pro XL
    { 0x34, 0x2E, 0xB6, 0x1E, 0xC4, 0x46 },	// Huawei P20 Pro
    { 0xB2, 0x55, 0x3F, 0xC9, 0xFC, 0xE8 },	// Apple iPhone XR
};
*/
// no randomization
const uint8_t TARGET_MACS[][6] = {
    { 0x20, 0xF0, 0x94, 0x11, 0x82, 0x14 },	// Google Pixel 9 Pro XL
    { 0x34, 0x2E, 0xB6, 0x1E, 0xC4, 0x46 },	// Huawei P20 Pro
    { 0xD8, 0x1C, 0x79, 0xDE, 0x34, 0xE1 },	// Apple iPhone XR
};
